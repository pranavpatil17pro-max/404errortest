...
/* Mobile responsive overrides (max-width: 640px) */
...
export default function App() {
  return (
    <>
      {/* Inject custom font face and exact rule definitions */}
      <style>{styleSheet}</style>

      <main className="relative w-full min-h-[100svh] bg-black overflow-x-hidden flex flex-col justify-center items-center">
        {}
        <video
          autoPlay
          loop
        ...
        {}
        <div className="header-logo-container" aria-label="LGPSM">
          {/* Logo Mark: 54px x 40px */}
          <svg
            width="54"
            height="40"
            viewBox="0 0 54 40"
          ...
          {/* 14px gap spacing between mark and logotype */}
          <div className="w-[14px] flex-shrink-0" />

          {/* Logotype SVG: 164.311px x 100px viewBox frame */}
          <svg
            width="165"
            height="100"
        ...
        <div className="center-content-group">
          {/* Large 404 Heading */}
          <h1 className="geist-mono heading-404 heading-404-gradient">
            404
          </h1>

          {/* Solid white thin divider */}
          <div className="divider-line" />

          {/* Message Text */}
          <p className="geist-mono message-text">
